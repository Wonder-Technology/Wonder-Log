...
[@bs.val] [@bs.scope "console"] external log4 : ('a, 'b, 'c, 'd) => unit = "log";
...
[@bs.val] [@bs.scope "console"] external info4 : ('a, 'b, 'c, 'd) => unit = "info";
...
[@bs.val] [@bs.scope "console"] external warn4 : ('a, 'b, 'c, 'd) => unit = "warn";
...
[@bs.val] [@bs.scope "console"] external error3 : ('a, 'b, 'c) => unit = "error";
